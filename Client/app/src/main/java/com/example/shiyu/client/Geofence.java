...
public class Geofence implements OnClickListener {
    ...
    protected static void addEntity() {
        ...
        String columnKey = "";
        TraceActivity.client.addEntity(TraceActivity.serviceId, entityName, columnKey, TraceActivity.entityListener);
    }

    private void createFence() {

        String creator = TraceActivity.entityName;
        String fenceName = TraceActivity.entityName + "_fence";
        String fenceDesc = "test";
        String monitoredPersons = TraceActivity.entityName;
        String observers = TraceActivity.entityName;
        ...
        TraceActivity.client.createCircularFence(TraceActivity.serviceId, creator, fenceName, fenceDesc,
    ...
    private void updateFence() {
        ...
        TraceActivity.client.updateCircularFence(TraceActivity.serviceId, fenceName, fenceId, fenceDesc,
                monitoredPersons,
    ...
    private void queryFenceList() {
        String creator = TraceActivity.entityName;
        String fenceIds = "";
        TraceActivity.client.queryFenceList(TraceActivity.serviceId, creator, fenceIds, geoFenceListener);
    }

    private void monitoredStatus() {
        int fenceId = Geofence.fenceId;
        String monitoredPersons = TraceActivity.entityName;
        TraceActivity.client.queryMonitoredStatus(TraceActivity.serviceId, fenceId, monitoredPersons,
                geoFenceListener);
    }
    ...
    private void historyAlarm() {
        ...
        TraceActivity.client.queryFenceHistoryAlarmInfo(TraceActivity.serviceId, fenceId, monitoredPersons, beginTime,
                endTime,
                geoFenceListener);
    }
    ...
    private void delayAlarm() {
        int fenceId = Geofence.fenceId;
        String observer = TraceActivity.entityName;
        int delayTime = (int) (System.currentTimeMillis() / 1000 + this.delayTime * 60);
        TraceActivity.client.delayFenceAlarm(TraceActivity.serviceId, fenceId, observer, delayTime,
                geoFenceListener);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_setfence:
                inputDialog();
                TraceActivity.mBaiduMap.setOnMapClickListener(mapClickListener);
                popupwindow.dismiss();
                break;
        ...
        builder.setTitle("围栏半径(单位:米)").setView(circleRadius)
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        TraceActivity.mBaiduMap.setOnMapClickListener(null);
                    }
